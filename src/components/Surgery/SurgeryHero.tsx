        ...
        <div className="grooming-hero-grid" style={{
          ...
          <div className="grooming-hero-content animate-fade-in">
            <h1 style={{ fontSize: '3.5rem', fontWeight: 800, lineHeight: 1.2, color: '#1a1a1a', marginBottom: '1.5rem' }}>
              Advanced Pet <span style={{ color: 'var(--primary)' }}>Surgery</span>
            </h1>
            ...
            <Link to="/contact-us" className="btn btn-primary" style={{ padding: '1rem 2rem', fontSize: '1.1rem', borderRadius: '50px', display: 'inline-flex', alignItems: 'center', gap: '0.5rem', fontWeight: 600 }}>
